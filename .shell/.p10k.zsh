# Generated by Powerlevel10k configuration wizard on 2023-08-30 at 21:17 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='[' $'u2009'
  ...
  ################################[ prompt_char: prompt symbol ]################################
  # Green prompt symbol if the last command succeeded.t symbol ]################################
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION=$'󰯪 '
  # Prompt symbol in command vi mode.󰂣
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=221
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=223
